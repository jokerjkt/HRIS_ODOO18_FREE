...
class SelfieCheckIn extends Component {
    ...
    async onSubmit() {
        ...
        try {
            ...
            const result = await rpc("/hr_payroll_indonesia/selfie_checkin", {
...
SelfieCheckIn.template = "hr_payroll_indonesia.SelfieCheckIn";

registry.category("actions").add("hr_payroll_indonesia.selfie_checkin", SelfieCheckIn);
